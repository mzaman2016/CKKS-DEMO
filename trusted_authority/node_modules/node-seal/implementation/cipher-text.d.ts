...
export type CipherTextDependencies = (deps: CipherTextDependencyOptions) => CipherTextConstructorOptions;
export type CipherTextConstructorOptions = (params?: CipherTextConstructorParams) => CipherText;
